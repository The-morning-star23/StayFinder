    ...
    <div>
      ...
      <section className="hero">
        <div className="hero-overlay">
          ...
          <p className="hero-subtitle">StayFinder connects travelers with affordable, comfortable, and verified homes worldwide.</p>
      ...
      <section className="about">
        <div className="about-content">
          <div className="about-text">
            ...
            <p>StayFinder is a trusted platform for digital nomads, remote workers, and travelers seeking safe, verified, and community-driven accommodations. Whether it’s a weekend getaway or a long-term workcation, we have your next home.</p>
          </div>
      ...
      <footer className="footer">
        ...
        <p className="footer-copy">© 2025 StayFinder. All rights reserved.</p>
      </footer>
    </div>
  );
}
